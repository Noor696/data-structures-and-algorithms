...
const raisedToTheThird = (arr) => {
  // Solution code here...
  const raisedToTheThirdArray = [];
  arr.forEach(number => raisedToTheThirdArray.push(Math.pow(number, 3)));
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  const arreach = [];
  arr.forEach(number => arreach.push(Math.pow(2, number)));
  return arreach;
};
