...
const typeNum = (arr) => {
  // Solution code here...
  const filterArray = arr.filter(value => !isNaN(value))
  return filterArray;
};
...
const containsAnd = (arr) => {
  // Solution code here...
   const andArr= arr.filter(str => str.includes("and"));
   return andArr;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  const filternotInFirstArr = arr.filter(value => !(forbiddenValues.includes(value)))
  return filternotInFirstArr;
};
